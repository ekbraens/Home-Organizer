...
{
    // Create a BNRItem and add it to the store
    BNRItem * newItem = [[BNRItemStore sharedStore] createItem];
    
    // Figure out where that item is in thr array
    NSInteger lastRow = [[[BNRItemStore sharedStore] allItems] indexOfObject:newItem];
    NSIndexPath * indexPath = [NSIndexPath indexPathForRow:lastRow inSection:0];
    
    // insert ths new row into the table
...
- (instancetype)init
{
    ...
    if (self)
    {
       ...
       // }
        ...
        // addNewIte: to BNRItemsViewController
...
{
    // make a new detailviewcontrolller when a row is selected
